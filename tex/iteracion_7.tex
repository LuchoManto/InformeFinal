...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.80\textwidth, height = 7cm]{bloquessoftconsensor}
  \caption{Diagrama de bloques de software del sistema de adaptacion del sensor}\label{fig:bloquessoftconsensor}
\end{figure}


\begin{figure}[h]
  \centering
  \includegraphics[width=0.80\textwidth, height = 7cm]{actividadcontrolrpm}
  \caption{Diagrama de actividad que describe el comportamiento de la funcion "control_rpm".}[Diagrama de actividad que describe el comportamiento de la funcion "control_rpm". que realiza el control de velocidad del motor del sensor.]\label{fig:actividadcontrolrpm}
\end{figure}
