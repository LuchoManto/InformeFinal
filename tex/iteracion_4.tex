...
\begin{figure}	
\centering
  \includegraphics[width=1.10\textwidth, height = 12cm]{esquematicoPotencia2}
...
\begin{figure}	
\centering
  \includegraphics[width=1.10\textwidth, height = 12cm]{PCB2a}
  \caption{Diseño PCB de la capa frontal de la placa.}\label{fig:PCB2a}
\end{figure}

\begin{figure}	
\centering
  \includegraphics[width=1.10\textwidth, height = 12cm]{PCB23Da}
...
\begin{figure}	
\centering
  \includegraphics[width=1.10\textwidth, height = 12cm]{PCB2b}
  \caption{Diseño PCB de la capa posterior de la placa.}\label{fig:PCB2b}
\end{figure}

\begin{figure}	
\centering
  \includegraphics[width=1.10\textwidth, height = 12cm]{PCB23Db}
